...
public:
	...
	**/
	...
	inline int GetLineSize() const { return sizeGrid.first; }
	inline int GetColumnSize() const { return sizeGrid.second; }
	inline int GetSize() const { return GetLineSize() * GetColumnSize(); }
	...
	void SetCellOwner(const int& idCell, const int& value);
